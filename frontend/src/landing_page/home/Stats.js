            ...
            <div className='row mt-5'>
                ...
                <div className='col-6'>
                    ...
                    <div className='text-center mt-3'>
                        <a href='' className='mx-5' style={{textDecoration:"none"}}>Explore our Products<i class="fa-solid fa-arrow-down fa-rotate-270"></i></a>
                        <a href=''style={{textDecoration:"none"}}>Try Kite demo<i class="fa-solid fa-arrow-down fa-rotate-270"></i></a>
                    </div>
                </div>
            </div>
        </div>
